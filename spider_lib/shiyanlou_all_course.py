...
def main():
            ...
            <div class="row course-cates">
                ...
                <div class="col-md-11 course-cates-content">
                    ...
                    <div class="course-cates-vip ">
                        <a target="_blank" href="/vip"><img src="https://static.shiyanlou.com/img/icon-vip.png"></a>
            ...
            <div class="media userinfo-header">
                <div class="media-left">
                    <div class="user-avatar">
                        ...
                        <a class="avatar" href="/user/63246/" target="_blank">
                            <img src="https://dn-simplecloud.shiyanlou.com/gravatarNTY0MzE5MDc1OTIx.png?v=1467272233337&amp;imageView2/1/w/200/h/200">
                         </a>

                         <a class="member-icon" href="/vip" target="_blank">

    <img src="
                https://static.shiyanlou.com/img/icon-vip.png
              ">
                ...
                <div class="media-body">
                    ...
                    <span class="media-heading username"><a href="/user/63246/" title="布啦豆">布啦豆</a></span>
                    <span class="user-level">L15</span>

                     <p class="vip-remain">会员剩余27天 <a href="/vip">续费&gt;&gt;</a></p>
            ...
            <div class="row userinfo-data">
                ...
                <div class="col-md-4 col-xs-4 data-item">
                    <p class="counter-p" href="/user/63246/"><span>15</span><br>楼</p>
                </div>
                <div class="col-md-4 col-xs-4 data-item">
                    <a class="counter-a" href="/user/63246/"><span class="with-href">50</span><br>课程</a><br>
                </div>
                <div class="col-md-4 col-xs-4 data-item">
                    <a class="counter-a" href="/user/63246/questions"><span class="with-href">0</span><br>提问</a><br>
                </div>
            ...
            <div class="userinfo-last-learn">
                ...
                <a class="last-course-name" href="/courses/581">基于 Flask 及爬虫实现微信娱乐机器人</a>

            </div>
            <div class="userinfo-continue-learn">

                <a class="btn btn-primary btn-lg" href="/courses/581">继续学习</a>
                            ...
                            <div class="modal-body">
                                ...
                                <form id="private-course-form" method="POST" action="/courses/join">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="code" name="code" value="" type="text">
                                        <input name="_csrf_token" value="1487907241##fa5961aefc81b5f3855073d31145cf0553663a72" type="hidden">
                                    </div>
                                </form>
    ...
    <div class="sidebox">
        ...
        <div class="sidebox-body">
            ...
            <div>
                <a href="/courses/581">基于 Flask 及爬虫实现微信娱乐机器人 - 支持逆序自动回复</a>
            </div>
            <br>
            <div>
            <a class="btn btn-primary user-vm-btn" data-clear="/courses/clear" data-start="/courses/start/1930" data-run="/courses/running" href="#">启动实验环境</a>
            </div>
    ...
    <div class="side-image side-qrcode">
        ...
        <div id="base-data" data-flash="false" data-is-login="true" data-jwt-token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzaGl5YW5sb3U6d2ViOmFwcCIsInVuYW1lIjoiXHU1ZTAzXHU1NTY2XHU4YzQ2IiwidWlkIjoiNjMyNDYiLCJleHAiOjE0ODc5MDcyNDIsImlhdCI6MTQ4NzgyMDg0Mn0.QbeCrEtL1L-jmq-DJjjpJUqECYKHNIKEfl229UHcVdI" data-user-id="63246" data-is-jwt="true" data-socket-url="wss://comet.shiyanlou.com" data-msg-user="" data-msg-system=""></div>
    ...
    <div id="jinja-data" data-loginurl="/login" data-private-course-url="/courses/join" data-site-type="0" data-apply-git-url="/user/git"></div>

    <script src="/app/dist/js/course/index.js?=201702222257"></script><div style="display: none; position: fixed; top: 0px; left: 0px; right: 0px; bottom: 0px; background: rgba(0, 0, 0, 0.5) none repeat scroll 0% 0%; text-align: center; z-index: 1600;"><i class="fa fa-spinner fa-pulse" style="margin-top: 244.4px; color: rgb(255, 255, 255); font-size: 35px;"></i></div>
